...
const steps = [
  ...
  { icon: Music2, title: "Всё работает сразу", text: "Поиск, воспроизведение и рекомендации работают из коробки — без единого ключа. Yandex, Spotify и Last.fm можно подключить в Настройках по желанию: они лишь расширяют каталог и делают рекомендации точнее." },
